...
Task<Void> task = new Task<Void>() {
    ...
    public void createKeyActions() {
    	...
    	keyActions.put(KeyCode.UP, () -> {System.out.println("UP");});
    	keyActions.put(KeyCode.DOWN, () -> {System.out.println("DOWN");});
    	keyActions.put(KeyCode.SPACE, () -> {System.out.println("SPACE");});
