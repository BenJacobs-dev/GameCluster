...
public class BlockBreakerMain extends Application {
  ...
  int fps = 1000 / 60, sizeX = 40, sizeY = (int) (sizeX * 1.33), mapSizeX = 1500 / sizeX, mapSizeY = 1000 / sizeY,
      displaySizeX = sizeX * mapSizeX, displaySizeY = sizeY * mapSizeY;
  ...
  public void start(Stage primaryStage) {
    ...
    // setSquareColor((int)(mouse.getSceneX()/(mapSizeX)),
    // (int)(mouse.getSceneY()/(mapSizeY)), colorList.get(-1));
    // }
    // });
  ...
  public void createKeyActions() {
    ...
    keyActions.put(KeyCode.LEFT, () -> {
      player.setX(Math.max(player.getX() - 10, 0));
    });
    keyActions.put(KeyCode.RIGHT, () -> {
      player.setX(Math.min(player.getX() + 10, 1400));
    });
